...
$(document).ready(function() {
  ...
  $("a.poemLinks").click(function() {
        ...
        $("#poemBox").html("Loading " + this.innerHTML +"...");
        $("#poemBox").load(poemName2,formatPoem(this.innerHTML));    
   });
...
function formatPoem(poemName) {
        var el = document.getElementById("poemBox");
        var str = el.innerHTML;
        //var res = str.replace(/\r\n/g, "<br/>");
        str = str.split("\n").join("<br/>");
        el.innerHTML="<strong>"+poemName+"</strong><br />By Avi Kazen<br /><br />"+str;
}
