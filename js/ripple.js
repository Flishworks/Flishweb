...
var startIndex=0;//index of first ripple. ripple removed after awhile
var ripples=[];
   ...
   for (var x=20;x<width-20;x+=res){
     ...
     for (var i=0;i<ripples.length;i++){
      ...
      push();
       ...
       rotateY(50.0*Math.atan(YdX/res)); //derivitive of x component
...
function mousePressed(){
  magCount=millis(); //track time mouse is pressed for magnitude of ripple
}
